...
[root@k8sm ~]$ cat nginx-deploy.yaml
apiVersion: apps/v1
kind: Deployment
metadata:
  labels:
...
ubectl label pods <your-pod-name> <label-name>-
...
[root@k8sm ~]$ kubectl explain DaemonSet | head -n 3
KIND:     DaemonSet
VERSION:  apps/v1

[root@k8sm ~]$ cat fluentd-daemonset.yml
apiVersion: apps/v1
kind: DaemonSet
metadata:
  name: fluentd
